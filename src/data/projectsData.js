export const projects = [
    ...
    },
    {
      ...
      description: "During HackMIT, my group sought to accurately detect real-time wildfires and evacuate people safely. For my part, I created a server system to connect to MQTT, allowing for WebSocket communication with an HTTP client. I used HTML geolocation, I displayed sensor data for temperature, humidity, and danger levels near the user. Also, I integrated Google Maps API to map the user's location and provide safe route suggestions away from danger zones. Together, our team achieved 2nd Place for IBM's sponsor challenge!",
      tags: ["MQTT", "WebSockets", "Google Maps API", "Geolocation", "Hackathon", "IBM"]
    },
    {
      id: 3,
