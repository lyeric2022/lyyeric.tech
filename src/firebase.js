...
const devGreeting = () => {
  ...
  const s = 'color: #ff8080; font-family: "SF Mono", "Monaco", "Inconsolata", "Fira Mono", "Droid Sans Mono", monospace; font-size: 11px; line-height: 1.4;';
  const warn = 'color: #ffcc00; font-family: "SF Mono", "Monaco", "Inconsolata", "Fira Mono", "Droid Sans Mono", monospace; font-size: 11px; line-height: 1.4;';
  const crit = 'color: #ff4444; font-family: "SF Mono", "Monaco", "Inconsolata", "Fira Mono", "Droid Sans Mono", monospace; font-size: 11px; line-height: 1.4; font-weight: 600;';
  const dim = 'color: #ddaaaa; font-family: "SF Mono", "Monaco", "Inconsolata", "Fira Mono", "Droid Sans Mono", monospace; font-size: 11px; line-height: 1.4;';
  const prog = 'color: #ff9999; font-family: "SF Mono", "Monaco", monospace; font-size: 11px;';
  const fail = 'color: #ff6666; font-family: "SF Mono", "Monaco", monospace; font-size: 11px; font-style: italic;';
  ...
  const messages = [
    ...
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: downloading http://' + c2IP + '/bd.sh', s], 0.8],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [░░░░░░░░░░░░░░░░░░░░] 0% (0/847KB)', prog], 0.5],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [██░░░░░░░░░░░░░░░░░░] 8% (68/847KB)', prog], 0.4],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [███░░░░░░░░░░░░░░░░░] 14% (119/847KB)', prog], 0.35],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: connection reset by peer, retrying...', fail], 1.2],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [███░░░░░░░░░░░░░░░░░] 14% (119/847KB)', prog], 0.6],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [█████░░░░░░░░░░░░░░░] 24% (203/847KB)', prog], 0.4],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [██████░░░░░░░░░░░░░░] 31% (263/847KB)', prog], 0.35],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [████████░░░░░░░░░░░░] 41% (347/847KB)', prog], 0.3],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [█████████░░░░░░░░░░░] 47% (398/847KB)', prog], 0.3],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [███████████░░░░░░░░░] 53% (449/847KB)', prog], 0.25],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [████████████░░░░░░░░] 58% (491/847KB)', prog], 0.25],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [██████████████░░░░░░] 68% (576/847KB)', prog], 0.3],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [███████████████░░░░░] 74% (627/847KB)', prog], 0.25],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [█████████████████░░░] 83% (703/847KB)', prog], 0.3],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [██████████████████░░] 89% (754/847KB)', prog], 0.25],
    [() => ['%c' + ts() + ' curl[' + (pid+2) + ']: [███████████████████░] 95% (805/847KB)', prog], 0.3],
    ...
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████░░░░░░░░░░░░░░░░] 22%', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████░░░░░░░░░░░░░░] 33%', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: timeout, switching mirror...', fail], 1],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████░░░░░░░░░░░░░░] 33%', prog], 0.6],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████████░░░░░░░░░░░░] 44%', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████████░░░░░░░░░░] 55%', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████████████░░░░░░░░] 67%', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████████████░░░░░░] 78%', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████████████████░░░░] 83%', prog], 0.25],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████████████████░░] 92%', prog], 0.3],
    ...
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: bruteforcing vault password...', s], 0.8],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [░░░░░░░░░░] attempting...', prog], 0.6],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█░░░░░░░░░] 52,103 attempts', prog], 0.5],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██░░░░░░░░] 89,274 attempts', prog], 0.45],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███░░░░░░░] 127,439 attempts', prog], 0.4],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: GPU memory exhausted, falling back to CPU', fail], 0.8],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████░░░░░░] 198,551 attempts', prog], 0.5],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████░░░░░] 251,847 attempts', prog], 0.4],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████░░░░] 298,102 attempts', prog], 0.4],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███████░░░] 367,294 attempts', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████████░░] 445,891 attempts', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████████░] 512,038 attempts', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████████] password found!', crit], 1.5],
    ...
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']:   + env_secrets.txt', dim], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [░░░░░░░░░░░░░░░░░░░░] 0% (0/23.7MB)', prog], 0.5],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██░░░░░░░░░░░░░░░░░░] 12% (2.8/23.7MB)', prog], 0.4],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████░░░░░░░░░░░░░░░] 24% (5.7/23.7MB)', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███████░░░░░░░░░░░░░] 37% (8.8/23.7MB)', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████████░░░░░░░░░░] 51% (12.1/23.7MB)', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████████████░░░░░░░░] 64% (15.2/23.7MB)', prog], 0.25],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███████████████░░░░░] 78% (18.5/23.7MB)', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████████████████░░░] 89% (21.1/23.7MB)', prog], 0.25],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████████████████████] 100% (23.7/23.7MB)', prog], 0.7],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: uploading to ' + c2IP + ':443/drop', s], 0.8],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [░░░░░░░░░░░░░░░░░░░░] 0%   ↑ 0KB/s', prog], 0.5],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██░░░░░░░░░░░░░░░░░░] 9%   ↑ 412KB/s', prog], 0.4],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███░░░░░░░░░░░░░░░░░] 17%  ↑ 847KB/s', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████░░░░░░░░░░░░░░░] 27%  ↑ 1.1MB/s', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: connection dropped, reconnecting...', fail], 1],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████░░░░░░░░░░░░░░░] 27%  ↑ resuming', prog], 0.6],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███████░░░░░░░░░░░░░] 38%  ↑ 1.2MB/s', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████████░░░░░░░░░░░] 46%  ↑ 1.3MB/s', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███████████░░░░░░░░░] 54%  ↑ 1.4MB/s', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████████████░░░░░░░] 64%  ↑ 1.2MB/s', prog], 0.25],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███████████████░░░░░] 73%  ↑ 1.1MB/s', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████████████████░░░] 83%  ↑ 1.0MB/s', prog], 0.25],
    ...
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█░░░░░░░░░] 184/1847 files', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███░░░░░░░] 412/1847 files', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████░░░░░░] 623/1847 files', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: skipped: file in use (chrome_profile.dat)', fail], 0.4],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████░░░░] 891/1847 files', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███████░░░] 1104/1847 files', prog], 0.25],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████████░░] 1298/1847 files', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████████░] 1502/1847 files', prog], 0.25],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████████░] 1691/1847 files', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████████] 1847/1847 files', prog], 0.6],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: encrypting /home/user/Pictures...', s], 0.6],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [████░░░░░░] 377/943 files', prog], 0.35],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [███████░░░] 660/943 files', prog], 0.3],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [██████████] 943/943 files', prog], 0.5],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: encrypting /home/user/Desktop...', s], 0.5],
    [() => ['%c' + ts() + ' /tmp/.x[' + (pid+4) + ']: [█████░░░░░] 64/127 files', prog], 0.35],
