...
export const metadata = {
  ...
  title: 'Babbling About Vibe-Coding',
  date: '4.26.26',
};
...
export const content = (
  <>
    ...
    <p>
      Unit tests are mandatory for ensuring proper validation behaviors. Deployments really depend on the number of customers & needs, and I generally dislike over-engineering. For most stuff though, I like to have separate branches for production, demo, staging, development, and localhost.
    </p>
    <br />
    ...
    <p>
      My philosophy is minimizing the number of vendors, so as to keep all projects as maintainable as possible. Supabase supports so much: general Postgres, pgvector, vaults, auth. This sucked though when connection limits were maxed and auth failed alongside it.
    </p>
    <br />
    ...
    <p>
      Software engineers are increasingly becoming just context engineers, and spec-driven development is quite popular at large orgs. I'm sure I've used such philosophy in some form, but perhaps agents maintaining a living record of past learnings and preferences may go further.
    </p>
    <br />

    <p>
      Parallelization vs concurrency, message queues, and content hashing are underrated. Docker & K8s are always cool, and it is so essential to understand the generated code. I feel like syntax doesn't matter anymore tbh, nor the styling of code, so long as it is readable by another developer. Modularity is very important, especially since refactors are now much more needed and frequent against the mass of generated code.
    </p>
    <br />

    <p>
      Key to long-running stateful agents is primarily sleep and planner/evaluator + doer agents.
    </p>
    <br />

    <p>
      LLM as a judge is decent + cheap for evals. Solve real problems & research novelty. Something interesting comes out literally every week now.
    </p>
  </>
);
