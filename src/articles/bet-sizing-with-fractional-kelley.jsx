...
export const content = (
  <>
    ...
    <p>
      The Kelly Criterion is one of my favorite formulas. 
    ...
    <p>
      The Negative Geometric Drag measures how volatility reduces compound returns.
    </p>
    ...
    <p>
      However, markets do also have fat tails, and variance is not truly known. 
    ...
    <br />
    <p>
      The arithmetic mean and geometric mean tell two different stories.
    </p>
    ...
    <p>
      ...
      The compounded outcome shows an 8% loss, not a 10% gain.
    </p>

    <br />
    <p>
      The simple average technically isn't wrong— it correctly calculates the average outcome. 
    ...
    <p>
      Yet you can actually still win with the Kelly Criterion! 
