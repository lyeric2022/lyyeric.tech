...
export const content = (
  <>
    ...
    <p>
      I was born to a Chinese-Viet dad and a Viet mom. My paternal grandfather served in the South Vietnamese army, and that side came to America as post-war political refugees after his release. My mom later came alone through sponsorship after meeting my dad. They worked very long hours in hard labor, and raised me up in Garden Grove, CA– a suburban area that hosts a very large Vietnamese diaspora. I love my Vietnamese heritage a lot, and I am so blessed to experience so much diverse cultural wealth that inhibits my geographic region.
    </p>
    <br />
    ...
    <p>
      I think it's general unsuccess stems from how current economic planners are not very capable, and such massive inefficiencies detract much of the promised social, national gains. My country does not lack talent and I have hope that my country will elect truly more competent economic leaders. It is sad that libertarians are able to evidence better outcomes from laissez-faire, as current systems incentivize policy makers to prioritize self-preservation over national duty.
    </p>
    <br />
    ...
    <p>
      On career, I have a strong desire to build a lot of wealth before age degrades my abilities, and I think the best way is to have ownership over endeavors that will benefit humanity. The larger, more complex problems tend to reward generously, and so I want to be early and involved in fields that have potential to solve such problems. As such, tech made the most sense. The tail rewards within tech are magnitudes larger than any other, and compared to healthcare and law, individual contributions are less tied to capital and time. I also love techy nerd culture and entrepreneurship, and both concepts' buildership mentalities tie quite nicely with my own.
    </p>
    <br />

    <p>
      Lastly, at a dinner not too long ago, I heard about a great perspective from an angel investor. He is quite successful in the eyes of many, loves his wife and children, and he treats life as a simulation, wherein he is the player tasked to navigate in-game uncertainties to attain his goals. I find this to be a gravely useful model for myself, and I greatly admire people whose convictions are so high. I find that success often follows those with strong, defensible convictions.
    </p>
    <br />
  </>
);
